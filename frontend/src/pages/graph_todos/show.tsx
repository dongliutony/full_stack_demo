...
const GraphTodoShow: React.FC = () => {
    const { id } = useParams();
    const { data, isLoading } = useOne({ resource: "graph_todos", id: id as string });
    ...
    return (
        <div style={{ maxWidth: 500, margin: "40px auto" }}>
            <Button onClick={() => navigate("/graph_todos")} style={{ marginBottom: 16 }}>
                Back
            </Button>
            <Card
